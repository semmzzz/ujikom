...
<body>
<nav class="navbar navbar-expand-lg texr-light bg-secondary">
        <div class="container">
            <strong>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="card mt-2">
                    <div class="card-header bg-secondary">Tambah Album</div>
                    <div class="card-body">
            ...
            <div class="col-md-8">
                <div class="card mt-2">
                    <div class="card-header bg-secondary">Data Album</div>
                    <div class="card-body">
                        <table class="table">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#edit<?php echo $data['albumid'] ?>">
                                        <!-- Button EDIT -->
                                        ...
                                        <div class="modal fade" id="hapus<?php echo $data['albumid'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-body">
                                                    <form action="../config/aksi_album.php" method="POST">
                                                        <input type="hidden" name="albumid" value="<?php echo $data['albumid'] ?>">
                                                        Apakah yakin anda ingin menghapus data? <strong> <?php echo $data['namaalbum'] ?></strong> ?

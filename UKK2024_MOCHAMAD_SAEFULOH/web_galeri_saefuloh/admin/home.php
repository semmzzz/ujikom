                    ...
                    <img style="height: 12rem" src="../asset/img/<?php echo $data['lokasifile']?>" class="card-img-top" title="<?php echo $data['judulfoto'] ?>">
                        <div class="card-footer text-center">
                            ...
                            if(mysqli_num_rows($ceklike) == 1) { ?>
                                <a href="../config/proses_like.php?fotoid= <?php echo $data['fotoid']?>" type="submit" name="like"><i class="fa fa-heart"></i></a>
                            
                            <?php } else { ?>
                                <a href="../config/proses_like.php?fotoid= <?php echo $data['fotoid']?>" type="submit" name="batalike"><i class="fa-regular fa-heart"></i></a>
                            <?php } 
                            ...
                            ?>
                            <a href=""><i class="fa-regular fa-message"></i></a>11 commentar
                        </div>
                    </div>
                </div>
            <?php } ?>
